...
public class MusicAdapterAct extends RecyclerView.Adapter<MusicAdapterAct.MyVieHolder> {
    // DECLARE VARIABLES
    private Context mContext;
    private ArrayList<FilesSongAct> mFiles = new ArrayList<>();

    MusicAdapterAct(Context mContext, ArrayList<FilesSongAct> mFiles){
        this.mFiles = mFiles;
    ...
    public void onBindViewHolder(@NonNull MyVieHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, RunningAct.class);
