...
public class RunningAct extends AppCompatActivity {
    ...
    int position = -1;
    ArrayList<FilesSongAct> listSongs = new ArrayList<>();
    static Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RunningAct.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (mediaPlayer != null){
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(RunningAct.this, ListSongAct.class);
                startActivity(back);
            }
        });
    }
